...
try {
    ...
    {
	new Image().src="//pixel.mathtag.com/error/img?error_domain=proper_pixel_1&what="+mm_encode(ex.message);
    }
})({"mt_pqc":"mt_aid","mt_lim":20,"mt_adid":"433287","language":"","mt_fpa":"1","mt_gfp":"mt_fp_mt_aid"});
