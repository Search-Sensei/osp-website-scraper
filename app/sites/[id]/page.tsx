...
export default function ClonedSiteViewer({ params }: { params: { id: string } }) {
  return (
    <div className="flex flex-col h-screen font-sans">
      <div className="bg-black text-white p-4 flex justify-between items-center shadow-md">
        <div>
          ...
          <p className="text-gray-400 text-xs">Viewing replication ID: {params.id}</p>
        </div>
      ...
      <div className="flex-1 w-full bg-gray-100">
        <iframe 
          src={`/sites/\${params.id}/index.html`} 
