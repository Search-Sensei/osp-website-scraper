    ...
    <div style={{ fontFamily }} className="sensei-top-search relative flex items-center h-full">
      {!expanded ? (
        <button
          ...
          className="flex items-center justify-center w-10 h-10 border border-slate-500 text-slate-700 bg-white rounded hover:bg-slate-100 transition-colors shadow-sm"
