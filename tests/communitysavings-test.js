...
(async () => {
  ...
  await page.goto('http://localhost:3000/scraper/sites/communitysavings_bank/index.html?q=bank', { waitUntil: 'networkidle' });
  ...
  if (cards.length > 0) {
    console.log('Test Passed Successfully! Search is working without page refresh on Community Savings Bank.');
  } else {
